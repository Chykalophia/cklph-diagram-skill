#!/usr/bin/env python3
"""Forwarder. The real lint-a11y.py lives inside the skill, which must be
...
_real = Path(__file__).resolve().parent.parent / "skills/cklph-diagram/scripts/lint-a11y.py"
