#!/usr/bin/env python3
"""Forwarder. The real brand-tokens.py lives inside the skill, which must be
...
_real = Path(__file__).resolve().parent.parent / "skills/cklph-diagram/scripts/brand-tokens.py"
